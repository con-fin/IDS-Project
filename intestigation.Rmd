...
p4 <- nhs_workforce %>%
  ...
  p5 # Plots the median percentage of visits within 4 hours for a certain quarter against the vacancies recorded for that quarter and fits a preliminary linear model to it. DO A PROPOER LINEA$R REGRESSION
