...
```
---
- From this it can be seen that there is an inverse relationship between the number of hospital addmissions for COVID and the number of A and E admissions.
